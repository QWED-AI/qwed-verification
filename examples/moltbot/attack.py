from vulnerable import VulnerableMoltbot
from protected import SecureMoltbot

def run_attack_simulation():
    print("\n\n" + "="*60)
    print("⚔️  MOLTBOT VULNERABILITY vs QWED PROTECTION  ⚔️")
    print("="*60 + "\n")
    
    vulnerable = VulnerableMoltbot()
    protected = SecureMoltbot()
